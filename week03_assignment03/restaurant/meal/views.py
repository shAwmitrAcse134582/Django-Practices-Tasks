...
def index(request):
    ...
    },
    {
      ...
      "strCategoryDescription": "Chicken is a type of domestic fowl, a subspecies of the red junglefowl. It is one of the most common and widespread domestic animals, with a total population of more than 19 billion as of 2011.[1] Humans commonly keep chickens as a source of food (consuming both their meat and eggs) and, more rarely, as pets."
    },
    {
      "idCategory": "3",
      "strCategory": "Dessert",
    ...
    },
    {
      ...
      "strCategoryDescription": "General foods that don't fit into another category.Lorem Ips is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."
    },
    {
      "idCategory": "6",
      "strCategory": "Pasta",
